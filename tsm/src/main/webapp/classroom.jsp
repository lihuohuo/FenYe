...
<div id="one">
    <c:forEach items="${list}" var="item">
        <c:if test="${item.id%2!=0}">
            <div id="dlg${item.id}" class="easyui-dialog" title="${item.name}"
                 style="width:230px;height:200px;padding:10px;border: 2px;margin-left: 5px"
                 data-options="
        ...
        <c:if test="${item.id%2==0}">
            <div id="dlg${item.id}" class="easyui-dialog" title="${item.name}"
                 style="width:230px;height:200px;padding:10px;border: 2px"
                 data-options="
...
<div id="dlgpwd" class="easyui-dialog" title="修改" style="width:600px;height:200px;padding:10px;border: 2px"
    ...
    <form id="userForms" com.action="/select.do" method="post">
        <table border="1">
            ...
            <tr>
                <td>上午</td>
                <td><input name="mon" id="mon" style="width:65px;" class="easyui-validatebox"  required="true"
                           readonly/></td>
            ...
            <tr>
                ...
                <td>下午</td>
                <td><input name="monn" id="monn" style="width:65px;" class="easyui-validatebox"  required="true"
                           readonly/></td>
